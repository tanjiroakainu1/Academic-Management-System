...
const links = [
  { label: 'Enroll in Courses', path: 'enrollment', icon: BookOpen, color: 'bg-gradient-to-br from-green-500 to-emerald-600', description: 'Browse & enroll' },
  { label: 'Class Schedules', path: 'schedules', icon: Calendar, color: 'bg-gradient-to-br from-emerald-500 to-emerald-600', description: 'Your timetable' },
  { label: 'Learning Materials', path: 'materials', icon: Upload, color: 'bg-gradient-to-br from-teal-500 to-teal-600', description: 'Course resources' },
  ...
  { label: 'Grades & Records', path: 'grades', icon: Award, color: 'bg-gradient-to-br from-emerald-600 to-teal-700', description: 'View scores' },
  { label: 'Academic Progress', path: 'progress', icon: TrendingUp, color: 'bg-gradient-to-br from-green-500 to-emerald-600', description: 'Track graduation' },
