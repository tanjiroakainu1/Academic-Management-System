...
const darkVariantStyles: Record<PublicButtonVariant, string> = {
  ...
  register:
    'border border-emerald-400/30 bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 text-white shadow-xl shadow-emerald-900/40 ring-1 ring-white/15 hover:from-emerald-500 hover:via-teal-500 hover:to-green-500 hover:shadow-2xl hover:-translate-y-0.5',
  primary:
  ...
  submitRegister:
    'w-full border border-emerald-400/30 bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 text-white shadow-xl shadow-emerald-900/35 hover:from-emerald-500 hover:via-teal-500 hover:to-green-500 hover:shadow-2xl',
}
...
const lightVariantOverrides: Partial<Record<PublicButtonVariant, string>> = {
  ...
  signIn:
    'border-2 border-emerald-200 bg-emerald-50 text-emerald-800 shadow-sm ring-1 ring-emerald-100/80 hover:border-emerald-300 hover:bg-emerald-100 hover:text-emerald-900 hover:shadow-md hover:-translate-y-0.5',
  ghost:
...
const focusRingStyles: Record<ButtonSurface, string> = {
  ...
  light: 'focus-visible:ring-emerald-500/35',
}
...
export function PublicButton({
  ...
  const activeRing =
    surface === 'light'
      ? active
        ? 'ring-2 ring-emerald-400/60 ring-offset-2 ring-offset-white'
        : ''
      : active
          ...
          return (
            <Link
              ...
              className={`inline-flex min-h-[36px] min-w-[36px] items-center justify-center gap-1.5 rounded-lg px-2.5 text-xs font-bold transition-all duration-200 active:scale-[0.97] sm:min-h-[38px] sm:min-w-0 sm:px-3.5 sm:text-sm ${
                active
                  ? 'bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 text-white shadow-lg ring-2 ring-white/25'
                  : 'bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 text-white shadow-md hover:from-emerald-500 hover:via-teal-500 hover:to-green-500 hover:shadow-lg'
              }`}
            >
